...
\textbf{\texttt{kauditd}} & Linux Kernel & POSIX Kernel & Ring 0 Kernel vs Ring 3 Userspace & Plaintext sequential logs (Requires external syslog) & Manual syslog forwarder \\
\textbf{\texttt{transparency.dev}} & Go & Tessera & Process boundary & Tile Merkle Tree + Witness Signatures & Static HTTP tiles / Checkpoint witnesses \\
\textbf{\texttt{sigstore.dev}} & Go & Trillian & Container / Microservice & Merkle Transparency Tree + Rekor Sigstore & DB-backed consensus \\
